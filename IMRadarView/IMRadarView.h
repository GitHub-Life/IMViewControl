...
typedef NS_ENUM(NSInteger, IMRadarViewType) {
    IMRadarViewTypeScan,
    IMRadarViewTypeDiffuse
};

@interface IMRadarView : UIView
 ...
 *  @return 扫描 雷达 View
 */
+ (IMRadarView *)scanRadarViewWithRadius:(CGFloat)radius
                                 angle:(int)angle
 ...
 *  @return 扩散 雷达 View
 */
+ (IMRadarView *)diffuseRadarViewWithStartRadius:(CGFloat)startRadius
