...
@interface IMRadarView ()

#pragma mark - 扫描类型的IMRadarView 属性
/** 扇形半径 */
...
#pragma mark - 扩散类型的IMRadarView 属性
/** 扩散动画 起始 的半径 */
...
@property (nonatomic, assign) IMRadarViewType radarViewType;

@end

@implementation IMRadarView

+ (IMRadarView *)scanRadarViewWithRadius:(CGFloat)radius angle:(int)angle radarLineNum:(int)radarLineNum hollowRadius:(CGFloat)hollowRadius {
...
- (instancetype)initWithRadius:(CGFloat)radius
    ...
    if (self = [super init]) {
        self.radarViewType = IMRadarViewTypeScan;
...
+ (IMRadarView *)diffuseRadarViewWithStartRadius:(CGFloat)startRadius endRadius:(CGFloat)endRadius circleColor:(UIColor *)circleColor {
...
- (instancetype)initWithStartRadius:(CGFloat)startRadius endRadius:(CGFloat)endRadius circleColor:(UIColor *)circleColor {
    if (self = [super init]) {
        self.radarViewType = IMRadarViewTypeDiffuse;
...
- (void)drawRect:(CGRect)rect {
    // Drawing code
    if (_radarViewType == IMRadarViewTypeScan) {
        if (!_startColor) {
